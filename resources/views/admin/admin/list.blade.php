...
<div class="d-sm-flex align-items-center mb-4" style="justify-content: right;">
    ...
    <a class="btn btn-primary btn-sm d-none d-sm-inline-block offline-hide" target="_blank" role="button"
...
<div class="modal fade" id="modalDoctores" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ url('/recisa/reporte/doctor') }}" method="GET" id="form-doctor" target="_blank">
                @csrf
